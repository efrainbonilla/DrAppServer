! function(that, $document, $window) {
	...
	script.loaderBody = function(browserSupport, browserFirefox, options) {
		var dataBrowser = {};

		var url_css_img = 'css/img/';
		if (options && options.urlImgRelative)
			url_css_img = options.urlImgRelative;
